...
import static com.alpgo.sdtool.constant.ApiContants.*;
...
public class StableDiffusionApiUtil {
    ...
    public StableDiffusionApiResponse sendApiToImg(Map<String, String> params, String content) throws IOException {
        ...
        String domain = params.get(STABLE_DIFFUSION_WEBUI_DOMAIN);
        String token = params.get(STABLE_DIFFUSION_WEBUI_TOKEN);
    ...
    private OkHttpClient getClient(Map<String, String> params) {
        String username = params.get(STABLE_DIFFUSION_WEBUI_USERNAME);
        String password = params.get(STABLE_DIFFUSION_WEBUI_PASSWORD);

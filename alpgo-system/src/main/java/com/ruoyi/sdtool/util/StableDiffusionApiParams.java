...
import static com.alpgo.sdtool.constant.ApiContants.maskImg;
import static com.alpgo.sdtool.constant.ApiContants.whiteBgImg;
...
public class StableDiffusionApiParams {
    ...
    public String toPreDict(String sessionHash) {
        ...
        extraGenerationParams.put("width", 512);
        extraGenerationParams.put("height", 512);
        ...
        params.put("session_hash", "42n9wjl1m2f");
    ...
    public String toPreDictForControlNet(String base64ImgString, String sessionHash) {
        return "{\n" +
                ...
                "        1,\n" +
                "        {\n" +
                "           \"image\": \"data:image/png;base64," + base64ImgString + "\"," +
                "            \"mask\": \""+ maskImg +"\"" +
                "        },\n" +
                "        false,\n" +

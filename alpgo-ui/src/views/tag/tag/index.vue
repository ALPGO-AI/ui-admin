<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="标签描述" prop="desctag">
        <el-input
          v-model="queryParams.desctag"
          placeholder="请输入标签描述"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="tagList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签描述" align="center" prop="desctag" />
      <el-table-column label="标签类别" align="center" prop="type" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="标签描述" prop="desctag">
          <el-input v-model="form.desctag" placeholder="请输入标签描述" />
        </el-form-item>
      </el-form>

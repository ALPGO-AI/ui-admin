...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'ALPGO-AI',   0, 'Admin', '15888888888', 'xxx@alpgo.cc', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'Admin', '00', 'xxx@alpgo.cc', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
...
insert into sys_menu values('4', 'AI工具', '0', '4', 'ai',              null, '', 1, 0, 'M', '0', '0', '', 'tool',     'admin', sysdate(), '', null, 'AI工具目录');
-- 二级菜单
...
insert into sys_menu values('117',  'Superset', '2',   '6', 'superset',      'monitor/superset/index',      '', 1, 0, 'C', '0', '0', 'monitor:superset:list',      'superset',         'admin', sysdate(), '', null, 'Superset菜单');
-- 三级菜单
